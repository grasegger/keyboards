...
RUN apk add --no-cache git build-base python3-dev py3-pip openjdk11 linux-headers wget unzip x11vnc py3-numpy py3-lxml imagemagick-libs py3-yaml subversion py3-psutil xvfb recordmydesktop xdotool gnome xdpyinfo npm
